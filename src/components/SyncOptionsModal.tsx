                ...
                <div className="p-5">
                    <div className="bg-white/5 rounded-xl p-4 mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div className="text-xs text-white/40">{itemCount} {mediaType === 'video' ? 'videos' : 'photos'}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <button
                            ...
                            className="w-full p-4 rounded-xl border border-purple-500/30 bg-purple-500/10 hover:bg-purple-500/20 transition-all group text-left"
                        >
